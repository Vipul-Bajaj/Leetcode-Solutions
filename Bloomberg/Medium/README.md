...
7. [Evaluate_Division](./Evaluate_Division.md)
8. [Flatten_a_Multilevel_Doubly_Linked_List](./Flatten_a_Multilevel_Doubly_Linked_List.md)
9. [Global_and_Local_Inversions](./Global_and_Local_Inversions.md)
10. [Kill_Process](./Kill_Process.md)
